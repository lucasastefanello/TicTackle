...
public class Game extends JFrame {
	...
	public Game() {
		...
		ImagePanel position_2_1 = new ImagePanel(new ImageIcon("images/tic.png").getImage());
		position_2_1.setBounds(17, 123, 103, 100);
		position_2_1.setBorder(BORDER_COMPOUND);
		
		ImagePanel position_2_2 = new ImagePanel(Toolkit.getDefaultToolkit().getImage(Game.class.getResource("/images/vazio.png")));
		position_2_2.setBounds(137, 123, 100, 100);
		position_2_2.setBorder(BORDER_COMPOUND);
		contentPane.setLayout(null);
		
		ImagePanel position_1_1 = new ImagePanel(Toolkit.getDefaultToolkit().getImage(Game.class.getResource("/images/tictackle2.gif")));
		...
		ImagePanel position_1_2 = new ImagePanel(Toolkit.getDefaultToolkit().getImage(Game.class.getResource("/images/tictackle1.gif")));
		...
		ImagePanel position_1_3 = new ImagePanel(Toolkit.getDefaultToolkit().getImage(Game.class.getResource("/images/tictackle2.gif")));
		...
		ImagePanel position_1_4 = new ImagePanel(Toolkit.getDefaultToolkit().getImage(Game.class.getResource("/images/tictackle1.gif")));
		...
		ImagePanel position_2_3 = new ImagePanel(Toolkit.getDefaultToolkit().getImage(Game.class.getResource("/images/vazio.png")));
		position_2_3.setBounds(254, 123, 100, 100);
		position_2_3.setBorder(BORDER_COMPOUND);
		contentPane.add(position_2_3);
		
		ImagePanel position_2_4 = new ImagePanel(Toolkit.getDefaultToolkit().getImage(Game.class.getResource("/images/vazio.png")));
		position_2_4.setBounds(371, 123, 100, 100);
		position_2_4.setBorder(BORDER_COMPOUND);
		contentPane.add(position_2_4);
		
		ImagePanel position_3_1 = new ImagePanel(Toolkit.getDefaultToolkit().getImage(Game.class.getResource("/images/vazio.png")));
		position_3_1.setBounds(18, 235, 100, 100);
		position_3_1.setBorder(BORDER_COMPOUND);
		contentPane.add(position_3_1);
		
		ImagePanel position_3_2 = new ImagePanel(Toolkit.getDefaultToolkit().getImage(Game.class.getResource("/images/vazio.png")));
		position_3_2.setBounds(136, 235, 100, 100);
		position_3_2.setBorder(BORDER_COMPOUND);
		contentPane.add(position_3_2);
		
		ImagePanel position_3_3 = new ImagePanel(Toolkit.getDefaultToolkit().getImage(Game.class.getResource("/images/vazio.png")));
		position_3_3.setBounds(254, 235, 100, 100);
		position_3_3.setBorder(BORDER_COMPOUND);

		contentPane.add(position_3_3);
		
		ImagePanel position_3_4 = new ImagePanel(Toolkit.getDefaultToolkit().getImage(Game.class.getResource("/images/vazio.png")));
		position_3_4.setBounds(372, 235, 100, 100);
		position_3_4.setBorder(BORDER_COMPOUND);

		contentPane.add(position_3_4);
		
		ImagePanel position_4_1 = new ImagePanel(Toolkit.getDefaultToolkit().getImage(Game.class.getResource("/images/tictackle1.gif")));
		...
		ImagePanel position_4_2 = new ImagePanel(Toolkit.getDefaultToolkit().getImage(Game.class.getResource("/images/tictackle2.gif")));
		...
		ImagePanel position_4_3 = new ImagePanel(Toolkit.getDefaultToolkit().getImage(Game.class.getResource("/images/tictackle1.gif")));
		...
		ImagePanel position_4_4 = new ImagePanel(Toolkit.getDefaultToolkit().getImage(Game.class.getResource("/images/tictackle2.gif")));
